    ...
    <div class="container">
      ...
      <div id="navcol-1" class="navbar-collapse">
        <ul class="navbar-nav me-auto">
          ...
          <li class="nav-item"><a class="nav-link" :class="{'active': isCurrentLinkEquals($utilsPath)}" :href="'#'+$utilsPath">Utils</a></li>
        </ul><button @click="logout" class="btn btn-primary" type="button">Logout</button>
      </div>
    </div>
  </nav>
</template>
...
export default {
  ...
  methods: {
    ...
    isCurrentLinkEquals(link) {
      return this.$router.currentRoute.value.path.includes(link)
    }
  }
}
